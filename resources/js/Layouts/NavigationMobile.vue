        ...
        <ul class="mt-6">
          ...
          <li class="relative px-6 py-3">
            <BreezeNavLink :href="route('city-halls.index')" :active="route().current('city-halls.*')">
              <template #icon>
                <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005">
          ...
          <li class="relative px-6 py-3">
            <BreezeNavLink :href="route('contacts.create')" :active="route().current('contacts.*')">
                <template #icon>
                    <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58 58">
